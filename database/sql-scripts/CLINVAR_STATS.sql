...
select ((select count(HPO_CODE) from clinvar_db.clinvar_data where HPO_CODE!='')/(select count(idclinvar_data) from clinvar_db.clinvar_data))*100; 
select ((select count(MEDGEN_CODE) from clinvar_db.clinvar_data where MEDGEN_CODE!='')/(select count(idclinvar_data) from clinvar_db.clinvar_data))*100; 
...
select ((select count(DBVAR_DB) from clinvar_db.clinvar_data where DBVAR_DB!='')/(select count(idclinvar_data) from clinvar_db.clinvar_data))*100; /*genes*/
select ((select count(DBSNP_DB) from clinvar_db.clinvar_data where DBSNP_DB!='')/(select count(idclinvar_data) from clinvar_db.clinvar_data))*100; /*genes*/
select ((select count(OMIM_DB) from clinvar_db.clinvar_data where OMIM_DB!='')/(select count(idclinvar_data) from clinvar_db.clinvar_data))*100; /*genes*/
select ((select count(VAR_TYPE) from clinvar_db.clinvar_data where VAR_TYPE!='')/(select count(idclinvar_data) from clinvar_db.clinvar_data))*100; /*genes*/
select ((select count(INTERPRETATION) from clinvar_db.clinvar_data where INTERPRETATION!='')/(select count(idclinvar_data) from clinvar_db.clinvar_data))*100; /*genes*/
