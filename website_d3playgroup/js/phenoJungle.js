...
var containerWidth = parseInt(d3.select("#phenoJungle").style("width"),0);//select and style give us access to the 
...
//get the size of the div before we change it to the minimum
	d3.select("#phenoJungle").style("width","800px").style("height","420px").style("overflow","hidden");
}
...
var svg = d3.select("#phenoJungle").append("svg")
...
d3.tsv("http://localhost:8080/phenoJungle.tsv",function(myData) {
